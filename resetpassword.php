...
<head>
    ...
    <style>
        ...
        h2 {
            ...
            /* Olive Green */
            margin-bottom: 30px;
            /* More space between title and other elements */
        }
        ...
        p {
            ...
            color: #777;
            margin-bottom: 30px;
            /* Added space below instructions */
        }
        ...
        .input-field {
            ...
            height: 50px;
            background: #ffffff;
            /* Pure White input field background */
            margin: 10px 0;
            border: 2px solid #C9C9A6;
            /* Warm Light Olive border */
            border-radius: 50px;
            display: flex;
            align-items: center;
        }
        ...
        .header1 {
            ...
            /* Allows repositioning of logo and navbar */
            padding: 15px 30px;
        ...
        .navbar {
            ...
            flex: 1;
            /* Allows it to occupy central space */
            text-align: center;
        }
        ...
        .cart-profile-container {
            ...
            gap: 15px;
            position: absolute;
            /* Positioned on the right corner */
            right: 20px;
            top: 20px;
