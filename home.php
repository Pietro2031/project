...
// Initialize an array to store slideshow image paths
$slides = [];
...
a moment of joy in every sip.
        ...
        <button class="cta-button">Learn More</button> <!-- Added button -->
      </div>
      
      <!-- Right Column (icon-based content) -->
      <div class="right-column-icons">
        <!-- Feature Box 1 (Mug Icon) -->
        <div class="feature-box">
          <i class="fa fa-mug-hot mug-icon"></i> <!-- Mug Icon -->
          <h4>Delicious Coffee</h4>
          <p>Experience the rich taste of freshly brewed coffee that will keep you coming back for more.</p>
        </div>

        <!-- Feature Box 2 (Organic Beans Icon) -->
        <div class="feature-box">
          <i class="fa fa-seedling beans-icon"></i> <!-- Organic Beans Icon -->
          <h4>Organic Beans</h4>
          <p>We use only the finest organic beans, carefully sourced to bring you the best flavors.</p>
        </div>

        <div class="feature-box">
          <i class="fa fa-coffee mug-icon"></i> <!-- Coffee Cup Icon -->
          <h4>Fresh Brews</h4>
  ...
  <div class="slideshow-container">
    ...
    foreach ($slides as $index => $slide) {
        $slideNumber = $index + 1; // Slide numbers are 1-based
...
<script>
ScrollReveal().reveal('.dream-clients2 li', { distance: '60px', origin: 'left', duration: 2000, delay: 400 });
